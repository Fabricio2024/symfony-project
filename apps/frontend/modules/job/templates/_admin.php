<div id="job_actions">
  ...
  <ul>
    <?php if (!$job->getIsActivated()) : ?>
      ...
      <li><?php echo link_to('Publish', 'job_publish', $job, array('confirm' => 'Are you sure?')) ?></li>
    <?php endif ?>
    <li><?php echo link_to('Delete', 'job_delete', $job, array('method' => 'delete', 'confirm' => 'Are you sure?')) ?></li>
    <?php if ($job->getIsActivated()) : ?>
      <li <?php echo $job->expiresSoon() ? ' class="expires_soon"' : '' ?>>
        ...
        <?php if ($job->expiresSoon()) : ?>
          - <?php echo link_to('Extend', 'job_extend', $job) ?> for another <?php echo sfConfig::get('app_active_days') ?> days
        <?php endif ?>
        </li>
      <?php else : ?>
        <li>
